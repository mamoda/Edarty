...
//هذا تطوير لداش بورد وإضافة زر للأبجريد
...
export default function Dashboard() {
  ...
  const handleUpgrade = () => {
    // يمكنك توجيه المستخدم إلى صفحة الاشتراك أو فتح نافذة منبثقة
    window.open("https://your-upgrade-link.com", "_blank");
    // أو يمكنك فتح مودال داخل التطبيق
...
//هذه صفحة الداش بورد بعد إضافة زر الأبجريد وإضافة البوت 
import { useState, useEffect } from "react";
import {
  Users,
  DollarSign,
...
//هذه صفحة الداش بورد قبل أي تعديلات 
import { useState, useEffect } from "react";
import {
  Users,
  DollarSign,
